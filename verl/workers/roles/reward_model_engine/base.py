...
_REWARD_MODEL_REGISTRY = {
    ...
    # TODO: implement dedicated GainRewardModel; temporarily reuse sglang engine to unblock pipeline.
    "gain": "verl.workers.roles.reward_model_engine.sglang_reward_model.SGLangRewardModel",
}
