...
class ValidationGenerationsLogger:
    ...
    def _log_generations_to_wandb(self, samples, step, wandb):
        ...
        # Always create a fresh table and overwrite the summary entry so that
        # only the latest validation rollout is kept in WandB.
        ...
        # Overwrite summary instead of logging a historical series
        if wandb.run is not None:
            wandb.run.summary["val/generations"] = new_table
