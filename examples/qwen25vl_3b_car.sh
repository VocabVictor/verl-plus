...
OUTPUT_DIR="${OUTPUT_DIR:-$WORKDIR/outputs/mm_eruka_qwen25vl_3b_cap}"
...
OVERRIDES=(
  ...
  "reward_model.name=gain"
  "reward_model.strategy=fsdp"
  "reward_model.model_type=generative"
  "reward_model.tensor_model_parallel_size=1"
  "reward_model.max_new_tokens=32"
  "reward_model.micro_batch_size_per_gpu=1"
  "reward_model.sampling_config.temperature=0.0"
  "reward_model.rm_score_weight=1.0"
  "reward_model.data_processor_config.path=${WORKDIR}/examples/reward/process_fn_gain.py"
  "reward_model.data_processor_config.preprocess_fn_name=construct_gain_inputs_from_rollouts"
  "reward_model.data_processor_config.postprocess_fn_name=convert_gain_responses_to_rewards"
  "reward_model.model.path=/data/wzh/wzh/models/qwen/Qwen2.5-7B-Instruct"
  "reward_model.model.input_tokenizer=/data/wzh/wzh/models/qwen/Qwen2.5-7B-Instruct"
  "reward_model.model.trust_remote_code=True"
  "reward_model.model.fsdp_config.param_offload=True"
  "reward_model.model_config.path=/data/wzh/wzh/models/qwen/Qwen2.5-7B-Instruct"
  "reward_model.model_config.trust_remote_code=True"
  "reward_model.input_model_config.path=/data/wzh/wzh/models/qwen/Qwen2.5-7B-Instruct"
  "reward_model.input_model_config.trust_remote_code=True"
  ...
  "trainer.experiment_name=mm_eruka_qwen25vl_3b_cap"
