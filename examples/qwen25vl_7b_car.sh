...
DEFAULT_MODEL_CANDIDATES=(
  "/root/wzh/models/Qwen2.5-VL-7B-Instruct"
  "/root/wzh/models/qwen/Qwen2.5-VL-7B-Instruct"
  "/workspace/models/qwen/Qwen2.5-VL-7B-Instruct"
)
...
OVERRIDES=(
  ...
  "trainer.experiment_name=qwen25vl7b_car"
