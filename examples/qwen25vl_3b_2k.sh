...
# Keep HF cache default unless you prefer the global path; uncomment to use /data/wzh/wzh cache.
# export HF_HOME="/data/wzh/wzh/.cache/huggingface"
...
OUTPUT_DIR="${OUTPUT_DIR:-$WORKDIR/outputs/qwen25vl3b_2k}"
...
OVERRIDES=(
  ...
  "trainer.experiment_name=mm_eruka_qwen25vl_3b_grpo_2k"
